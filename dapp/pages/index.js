...
export default function Home() {
  ...
  const [cdBalalnce, setCDBalalnce] = useState(zero);
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    if (chainId !== 4) {
      window.alert("Please connect to the Rinkeby");
      throw new Error("Please connect to the Rinkeby");
    }
    if (needSigner) {
      ...
      return (
        <div>
          <div className={styles.description}>
            You have:
            <br />
            {utils.formatEther(cdBalalnce)} Crypto Dev Tokens
            <br />
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        <div>
          {/* <Image className={styles.inage} src={images} /> */}
          <img className={styles.image} src="./cryptodev.svg" />
        </div>
      </div>

      <footer className={styles.footer}>Made with &#10084; by Chuckz</footer>
    </div>
  );
}
